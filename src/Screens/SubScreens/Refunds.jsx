    ...
    return (
        ...
        <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
          ...
          <div className=' mx-4 flex flex-row justify-between mb-8 mt-2 items-center '>
            <div className=' text-2xl text-gray-600'>Refund Requests</div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                    ...
                    <td className="pl-6 py-4 whitespace-nowrap">
                      <div className="flex space-x-2 w-min">
                        <button className=' text-sm px-8 bg-green-400 py-1 rounded-md'>Approve</button>
                        <button className=' text-sm px-8 bg-red-500 text-white  py-1 rounded-md'>Reject</button>
                      </div>
                    </td>
