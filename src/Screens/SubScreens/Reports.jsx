...
function Reports() {
    ...
    return (
        ...
        <form className=' mt-6'>
            ...
            <div><input placeholder='User Id' className=' text-center bg-transparent border-b hover:border-b-2 py-4 w-full  hover:border-gray-900 border-gray-600 cursor-pointer' /></div>
            <div><input placeholder='From Date' className=' text-center bg-transparent border-b hover:border-b-2 py-4 w-full  hover:border-gray-900 border-gray-600 cursor-pointer' /></div>
            <div><input placeholder='To Date' className=' text-center bg-transparent border-b hover:border-b-2 py-4 w-full  hover:border-gray-900 border-gray-600 cursor-pointer' /></div>
            <div><input placeholder='Status' className=' text-center bg-transparent border-b hover:border-b-2 py-4 w-full  hover:border-gray-900 border-gray-600 cursor-pointer' /></div>
            <div><input placeholder='Product ID' className=' text-center bg-transparent border-b hover:border-b-2 py-4 w-full  hover:border-gray-900 border-gray-600 cursor-pointer' /></div>
            <div><input placeholder='Transaction ID' className=' text-center bg-transparent border-b hover:border-b-2 py-4 w-full  hover:border-gray-900 border-gray-600 cursor-pointer' /></div>

            </div>
            <button className=' bg-green-500 text-white px-8 py-1 mt-6 font-medium rounded-md'> Submit</button>
        </form>
...
<div className=" overflow-x-auto w-full  pt-8">
        <div className="py-2 align-middle bg-white rounded-2xl inline-block min-w-full sm:px-6 lg:px-8">
          ...
          <div className=' mx-4 flex flex-row justify-between mb-8 mt-2 items-center '>
            <div className=' text-2xl text-gray-600'>Report Details:</div>
