...
function Transaction() {
    ...
    return (
        ...
        <div className=' flex flex-row'>
            <div><div className=" overflow-x-auto w-full  pt-8">
        <div className="py-2 align-middle bg-white rounded-2xl inline-block min-w-full sm:px-6 lg:px-8">
          ...
          <div className=' mx-4 flex flex-row justify-between mb-8 mt-2 items-center '>
            <div className=' text-xl text-gray-600'>New join Members</div>
            ...
            <table className="min-w-full divide-y   divide-gray-200">
              <thead className="bg-purple-500 text-white">
                <tr>
                  <th
                    scope="col"
                    className="px-6 py-3 text-left w-min text-xs font-medium  uppercase tracking-wider"
                  >
                    Actions
                  </th>
                  <th
            ...
            <table className="min-w-full divide-y   divide-gray-200">
              <thead className="bg-purple-600">
                <tr>
                  <th
                    scope="col"
                    className="px-6 py-3 text-left w-min text-xs font-medium text-white uppercase tracking-wider"
                  >
                    Image
                  </th>
                  <th
          ...
          <div className=' mx-4 flex flex-row justify-between mb-8 mt-2 items-center '>
            ...
            <table className="min-w-full divide-y   divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                    ...
                    <td className="pl-6 py-4 whitespace-nowrap">
                      <div className="flex space-x-2 w-min">
                        <button className=' text-sm px-8 bg-blue-500 text-white py-1 rounded-md'>Edit</button>
